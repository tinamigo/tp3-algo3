...
int main() {
	...
	while(true) {
		...
		int param_0 = 33;	// k = constante de la funcion de crecimiento
		int param_1 = 1;	// e = exponente de la funcion de crecimiento
		int param_2 = 6;	// ataque
		int param_3 = 6;	// defensa
		int param_4 = 3;	// ataque futuro
		int param_5 = 1;	// defensa futura
